<template>
  <div class="grid grid-cols-1 md:grid-cols-5 gap-4 p-5 w-full">
    <div class="md:col-span-3">
      <h1 class="text-xl italic">What have I done?</h1>
      <p class="pt-5">
        Some examples of my work, ranging from voluntary work for non profits to
        freelance projects.
      </p>
    </div>
    <Profile />
  ...
  <div class="gradient-section px-7 sm:px-10 md:px-5 pt-9">
    <ul class="bullet mt-0 md:mt-7">
      <div class="sm:grid sm:grid-cols-1 sm:grid-cols-8">
        <a
      ...
      <div class="grid grid-cols-1 sm:grid-cols-8">
        ...
        <li class="col-span-6 sm:col-span-7">
